...
class RunConfig:
    ...
    #: Whether the provider's reasoning is left on for the answering call.
    #:
    #: Left to the provider by default, because matching a fact to a question and choosing between
    #: similar options is real judgement. Set it explicitly to measure the trade.
